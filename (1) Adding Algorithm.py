...
def adding_algorithm(lst, k):
    ...
    for num in lst:
        ...
        # This nested for loop checks if num plus any other numbers (excluding itself, which is why we remove that value in line 11) in that list add up to k
...
adding_algorithm([10, 15, 3, 7], 354325)